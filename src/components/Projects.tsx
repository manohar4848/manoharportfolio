  ...
  const projects = [
    {
      ...
      description:
        'Full-stack platform supporting 200+ participants with scheduling and attendance tracking. Implemented secure authentication using Spring Security and role-based access control.',
    ...
    },
    {
      ...
      description:
        'Web application for student enrollment, attendance, and performance monitoring. Automated grading system improving academic efficiency.',
    ...
    },
    {
      ...
      description:
        'Helping students choose careers that balance passion, skills, and financial growth using AI-driven recommendations.',
      technologies: ['Python', 'Machine Learning', 'Google AI Studio', 'Kaggle'],
      highlights: [
      ...
      aiStudio:
        'https://aistudio.google.com/apps/drive/1Zx05k99ZTFWT_crXjiy1NPN2lfkIvg5J',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Real-world projects showcasing full-stack and AI development skills
          </p>
        </div>
            ...
            >
              <div className="md:flex">
                ...
                {project.image ? (
                  ...
                  <div
                    className={`md:w-2/5 bg-gradient-to-br ${project.color} p-8 flex items-center justify-center`}
                  >
